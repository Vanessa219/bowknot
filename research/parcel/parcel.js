...
// 入口文件路径
const file = Path.join(__dirname, './src/main/webapp/skins/v2ex/index.ftl')

// Bundler 选项
const options = {
  outDir: './dist', // 将生成的文件放入输出目录下，默认为 dist
  outFile: 'index.html', // 输出文件的名称
  publicUrl: 'http://static.com', // 静态资源的 url ，默认为 dist
...
console.log(require.resolve('./FTLAsset'))
bundler.addAssetType('.ftl', require.resolve('./FTLAsset'));
bundler.on('bundled', (a) => {
  console.log(a)
